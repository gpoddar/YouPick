											...
											<div class="well">
												...
												<div class="text-center">
													<div class="btn-group" style="margin-bottom:20px" role="group">
														...
														<form class="form-horizontal" enctype="multipart/form-data" id="addPollForm" role="form" action="PollEditController" method="post">
															...
															<div class="form-group" style="padding:14px;">
																<textarea class="form-control" placeholder="Start typing" id="question" name="question"><%=poll.getTitle() %></textarea>
															</div>
															<h4 class="center">Tag Category</h4>
															<div class="form-group" style="padding:14px;">
																<select name="category" class="form-control selectpicker" id="catrgoryselect">
																	<%
														...
														<div class="form-group">
															<div class="input-group col-sm-6" style="padding:14px;">
																...
																<input type="text" class="form-control" id="optionA" name="optionA" placeholder="" value="<%=poll.getOptionOne() %>"/>
															</div>
															<div class="input-group col-sm-6" style="padding:14px;">
																<div class="input-group-addon">B</div>
																<input type="text" class="form-control" id="optionB" name="optionB" placeholder="" value="<%=poll.getOptiontwo() %>"/>
															</div>
														</div>
														<div class="form-group" id="multipleOptions" style="display:none">
															<div class="input-group col-sm-6" style="padding-left:14px;padding-right:14px;padding-bottom:14px;">
																...
																<input type="text" class="form-control" id="OptionC" name="optionC" placeholder="" value="<%=poll.getOptionThree() %>"/>
															</div>
															<div class="input-group col-sm-6" style="padding-left:14px;padding-right:14px;padding-bottom:14px;">
																<div class="input-group-addon">D</div>
																<input type="text" class="form-control" id="optionD" name="optionD" placeholder="" value="<%=poll.getOptionFour() %>"/>
															</div>
														</div>
														<h4 class="center">Description</h4>
														<div class="form-group" style="padding:14px;">
															<textarea class="form-control" placeholder="Start typing" id="description" name="description"><%=poll.getDescription() %></textarea>
														</div>
														<input type="hidden" id="polltype" name="polltype" value="binary"/>
														<input type="hidden" id="oldimgsrc" name="oldimgsrc"/>
														<input type="hidden" id="pollid" name="pollid" value="<%=(long)poll.getPollId() %>"/>
...
<div id="previewModal" class="modal fade" style="" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="row" >
          <div class="col-sm-6 col-md-offset-3">
            <div class="panel panel-default">
              ...
              <div class="panel-thumbnail"><img class="img-responsive" id="imagediv" style="width:100%"></div>
              <div class="panel-body">
...
$('#catrgoryselect').val('<%=poll.getCategory()%>');	
$("#oldimgsrc").val("<%=poll.getImgSrc()%>");
$('#imagediv').attr('src','<%=poll.getImgSrc()%>');
});
</script>
