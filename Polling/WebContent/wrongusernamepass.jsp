...
<div class="column col-sm-12 col-xs-12" id="main">
  ...
  <div class="padding" id="mainscroll">
    <div class="full col-sm-12" id="innerBody">
      <div id="pagetop"></div>
      ...
      <div class="container">
        <div class="jumbotron">
          <h2 Style="text-align:center">Wrong Username/Password</h2> 
          <p Style="text-align:center">Please <a href="#loginModal" style="color:green" data-toggle="modal" data-dismiss="modal">Login</a> or <a href="#signupModal" style="color:green" data-toggle="modal" data-dismiss="modal">Signup</a> to continue</p> 
        </div>
      </div>
