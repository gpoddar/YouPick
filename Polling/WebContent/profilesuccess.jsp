        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown" style="display:block">
            ...
            <ul class="dropdown-menu">
              ...
              <%if(session.getAttribute("fbLogin").toString().equals("false")){ %> <%if(session.getAttribute("fbLogin").toString().equals("false")){ %><li><a href="changepassword.jsp">Change Password</a></li><%} %><%} %>
  ...
  <div class="padding" id="mainscroll">
    <div class="full col-sm-9" id="innerBody">
      ...
      <div class="pollElement">
        ...
        <h2 style="text-align:center">You have successfully updated your profile</h2>
      </div>
